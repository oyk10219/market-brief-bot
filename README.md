...
GitHub Actions는 GitHub 서버에서 실행되므로 로컬 Codex 앱이나 CLI를 사용할 수 없습니다. 노트북이 항상 켜져 있고 로컬 Codex를 활용하고 싶다면 Windows 작업 스케줄러로 아래 스크립트를 실행하면 됩니다.
...
- GitHub Actions 자동 실행과 로컬 작업 스케줄러를 동시에 켜면 같은 브리핑이 중복 전송될 수 있습니다.
